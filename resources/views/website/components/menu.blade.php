<ul class="navbar-nav ms-auto mb-2 mb-lg-0 nav-responsive" style="font-size: 20px">
    @php
    ...
    @foreach ($items as $item)
        ...
        @endphp
        @if($item->status)
            <button class="nav-item mx-3 {{ $isActive }} @if($hasChildren) dropdown dropdown-toggle @endif">
